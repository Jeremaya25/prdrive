...
def leeme() -> str:
    ...
    return (
        ...
        "\n"
        "Para quitarlo\n"
        f"  Cierra antes el contenedor: doble clic en «{NOMBRE_EXPULSAR}»\n"
        f"  (Linux: sh {v.EXPULSAR_SH}). Si quitas la unidad con el contenedor\n"
        "  abierto, puede estropearse lo de dentro.\n"
        "\n"
